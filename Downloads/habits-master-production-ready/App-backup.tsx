...
export default function App() {
  ...
  useEffect(() => {
    async function prepare() {
      try {
        // Initialize AdMob first (with error handling)
        // Temporarily disabled to fix bundling issues
        // try {
        //   await AdMobService.initialize();
        // } catch (admobError) {
        //   console.warn('AdMob initialization failed, continuing without ads:', admobError);
        // }
