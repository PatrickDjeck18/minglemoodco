-- =====================================================
-- FIXED SUPABASE SCHEMA FOR COMMENTS AND LIKES
-- (No data migration to avoid variable conflicts)
-- =====================================================
...
AND column_name IN ('likes_count', 'comments_count', 'shares_count', 'is_public')
