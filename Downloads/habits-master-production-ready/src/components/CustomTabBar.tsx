...
const CustomTabBar: React.FC<TabBarProps> = ({ state, descriptors, navigation }) => {
  ...
  const tabIcons = {
    ...
    Prayer: 'heart' as keyof typeof Ionicons.glyphMap,
    ChristianHabits: 'checkmark-circle' as keyof typeof Ionicons.glyphMap,
    FastingTracker: 'fast-food' as keyof typeof Ionicons.glyphMap,
