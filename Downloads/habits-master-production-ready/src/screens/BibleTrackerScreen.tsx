  ...
  useEffect(() => {
    const loadReadingData = async () => {
      try {
        ...
        const localSessions = await StorageManager.getItem<any[]>('reading_sessions') || [];
  ...
  const renderTimer = () => (
    <View style={styles.tabContent}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Bible Reading Timer - Temporarily disabled */}
        <GlassCard style={styles.timerCard}>
          <Text style={[styles.cardTitle, { color: colors.text }]}>Reading Timer</Text>
