...
const LoginScreen: React.FC<LoginScreenProps> = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <LinearGradient
        colors={isDark ? [colors.background, colors.dark.card] : [colors.background, colors.card]}
          ...
          <View style={styles.content}>
            ...
            <GlassCard style={styles.formCard}>
              <View style={styles.inputContainer}>
                ...
                <View style={[styles.inputWrapper, { borderColor: colors.border, backgroundColor: isDark ? colors.dark.background : colors.light.background }]}>
...
const styles = StyleSheet.create({
  ...
  divider: {
    flexDirection: 'row',
    alignItems: 'center',
    marginVertical: 32, // Increased vertical margin
  },
  dividerLine: {
    flex: 1,
    height: StyleSheet.hairlineWidth, // Use hairlineWidth for a crisp line
  },
  dividerText: {
    marginHorizontal: 16,
    fontSize: 14,
  ...
  socialButton: {
    ...
    borderRadius: 12,
    marginHorizontal: 8,
    backgroundColor: 'transparent', // Ensure background is transparent for outline variant
  },
  socialButtonText: {
    fontSize: 16,
    fontWeight: '600',
